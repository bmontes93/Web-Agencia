...
// SVGs for Brand Icons to ensure accuracy
const GoogleIcon = () => (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="text-center mb-8">
                ...
                <p className="text-slate-400 text-sm">Inicia sesión para acceder a tu panel.</p>
            </div>

            <div className="space-y-4">
                <button className="w-full bg-white hover:bg-slate-200 text-slate-900 font-medium py-3 px-4 rounded-xl flex items-center justify-center gap-3 transition-colors group">
                    <GoogleIcon />
                    Continuar con Google
                </button>
                
                <button className="w-full bg-[#1877F2] hover:bg-[#166fe5] text-white font-medium py-3 px-4 rounded-xl flex items-center justify-center gap-3 transition-colors">
                    <FacebookIcon />
                    Continuar con Facebook
                </button>

                <button className="w-full bg-black hover:bg-slate-900 text-white font-medium py-3 px-4 rounded-xl flex items-center justify-center gap-3 transition-colors border border-slate-800">
                    <XIcon />
                    Continuar con X
                </button>
            </div>
            ...
            <div className="my-8 flex items-center gap-4">
                ...
                <span className="text-slate-500 text-xs uppercase tracking-widest">O continúa con email</span>
                <div className="h-px bg-slate-800 flex-1" />
            </div>
            ...
            <form className="space-y-4">
                ...
                <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-bold py-3 px-4 rounded-xl transition-all shadow-lg shadow-blue-500/20">
                    Iniciar Sesión
                </button>
            </form>
